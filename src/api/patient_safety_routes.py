...
async def get_overview() -> OverviewResponse:
    ...
    org_roles = [
        ...
        {
            "role": "Head of Patient Safety / QPPV",
        ...
        {
            "role": "VP Pharmacovigilance Operations",
            "name": "VP PV Operations",
            "reports_to": "Head of Patient Safety / QPPV",
            "department": "PV Operations",
            "location": "Bangalore, India",
            "fte_direct_reports": 45,
        },
        {
            "role": "Director, Signal Management",
            "name": "Director, Signal Management",
            "reports_to": "Head of Patient Safety / QPPV",
            "department": "Signal Management",
            "location": "Lisbon, Portugal",
            "fte_direct_reports": 8,
        },
        {
            "role": "Director, Risk Management & Epidemiology",
            "name": "Director, Risk Management",
            "reports_to": "Head of Patient Safety / QPPV",
        ...
        {
            "role": "Director, Aggregate Reporting",
            "name": "Director, Aggregate Reporting",
            "reports_to": "Head of Patient Safety / QPPV",
        ...
        {
            "role": "Director, PV Quality & Compliance",
            "name": "Director, PV Quality",
            "reports_to": "Head of Patient Safety / QPPV",
            "department": "PV Quality",
    ...
    governance_bodies = [
        GovernanceBody(
            ...
            abbreviation="SMT",
            chair="Head of Patient Safety",
            frequency="Biweekly",
            last_meeting="2026-02-20",
            next_meeting="2026-03-06",
            members=12,
        ...
        GovernanceBody(
            ...
            abbreviation="RMC",
            chair="Director, Risk Management",
            frequency="Quarterly",
...
async def get_signals() -> SignalsResponse:
    ...
    active_signals = [
        SignalItem(
            ...
            priority="High",
            assigned_to="Director, Signal Management",
        ...
        SignalItem(
            ...
            priority="Medium",
            assigned_to="Director, Risk Management",
...
async def get_aggregate_reports() -> AggregateReportsResponse:
    ...
    reports = [
        AggregateReport(
            ...
            status="Drafting",
            progress_pct=15.0,
            assigned_lead="Director, Aggregate Reporting",
            reviewer="Head of Patient Safety",
            sections_complete=2,
            sections_total=16,
...
async def get_quality() -> QualityResponse:
    ...
    sop_inventory = [
        SOPItem(sop_id="PV-SOP-001", title="Individual Case Safety Report Processing", version="5.2",
                effective_date="2025-06-15", review_due="2026-06-15", owner="VP PV Operations",
                status=RAGStatus.GREEN),
        SOPItem(sop_id="PV-SOP-002", title="Signal Detection and Management", version="4.0",
                effective_date="2025-09-01", review_due="2026-09-01", owner="Director, Signal Management",
                status=RAGStatus.GREEN),
        SOPItem(sop_id="PV-SOP-003", title="Periodic Safety Update Report (PBRER/PSUR) Preparation", version="3.1",
                effective_date="2025-03-15", review_due="2026-03-15", owner="Director, Aggregate Reporting",
                status=RAGStatus.AMBER),
        SOPItem(sop_id="PV-SOP-004", title="Risk Management Plan Development and Maintenance", version="2.3",
                effective_date="2025-07-01", review_due="2026-07-01", owner="Director, Risk Management",
                status=RAGStatus.GREEN),
        ...
        SOPItem(sop_id="PV-SOP-006", title="Expedited Regulatory Reporting", version="4.1",
                effective_date="2025-08-01", review_due="2026-08-01", owner="VP PV Operations",
                status=RAGStatus.GREEN),
        SOPItem(sop_id="PV-SOP-007", title="Literature Surveillance for Safety Data", version="3.0",
                effective_date="2025-05-01", review_due="2026-05-01", owner="Director, Signal Management",
                status=RAGStatus.GREEN),
        SOPItem(sop_id="PV-SOP-008", title="Medical Review of ICSRs", version="2.2",
                effective_date="2025-10-15", review_due="2026-10-15", owner="Head of Patient Safety",
                status=RAGStatus.GREEN),
        SOPItem(sop_id="PV-SOP-009", title="Pharmacovigilance Agreements Management", version="2.0",
                effective_date="2025-01-15", review_due="2026-01-15", owner="Director, PV Quality",
                status=RAGStatus.RED),
        SOPItem(sop_id="PV-SOP-010", title="CAPA Management for PV Deviations", version="1.3",
                effective_date="2025-11-01", review_due="2026-11-01", owner="Director, PV Quality",
                status=RAGStatus.GREEN),
        SOPItem(sop_id="PV-SOP-011", title="PV System Master File (PSMF) Maintenance", version="2.1",
                effective_date="2025-06-01", review_due="2026-06-01", owner="Director, PV Quality",
                status=RAGStatus.GREEN),
        SOPItem(sop_id="PV-SOP-012", title="PV Training Program and Competency Assessment", version="1.5",
                effective_date="2025-09-15", review_due="2026-09-15", owner="Director, PV Quality",
                status=RAGStatus.GREEN),
    ]
    ...
    capa_items = [
        ...
        CAPAItem(
            ...
            due_date="2026-03-31",
            status="In progress",
            assigned_to="Director, PV Quality",
    ...
    audits_inspections = [
        ...
        {
            "type": "Vendor Audit",
            "scope": "Clintec PV Services (CRO) - case processing operations",
            "date": "2025-09-15",
            "lead": "Director, PV Quality + VP PV Operations",
            "status": "Completed",
            "findings_critical": 0,
            "findings_major": 0,
            "findings_minor": 4,
